...
|---|---|---|
| jul-2026-52 | Qntrl | 135 new workflow orchestration tools (blueprints, stages, services, circuits, action flows, webhooks, roles, teams, segments, screens, business rules) |
| jul-2026-01 | AnalyticsPlus | New Service — corrected to 25 tools (added `getViewDetails`, `getViews`, `moveViewsToFolder`, `renameFolder`, `updateRows`) |
| jul-2026-02 | Zoho CRM Plus | New Service — corrected to 18 tools (added `updateProjectExpenses`) |
